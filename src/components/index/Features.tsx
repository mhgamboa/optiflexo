      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2">
          <FeatureCard
            ...
            headingText2="Optimal Hex-Cell de grabado"
            description="Creado con las màs nueva tecnologìa làser de alta definiciòn de fibra òptica para
          ...
          <FeatureCard
            ...
            imgAlt="Hexagon Cell Shape"
            headingText1="OPTI X"
            headingText2="Reverse Pon Grabados"
            description="Ideal para trabajos de gran volumen con capas màs pesadas para tintas,
